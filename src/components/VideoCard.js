...
const VideoCard = ({ video }) => {
    ...
    return (
        <Link to={`watch?v=${id}`} onClick={toggleMenuHandler} className='card col-span-12 sm:col-span-6 md:col-span-6 min-[1000px]:col-span-4 mb-8 md:mb-5 lg:mb-8 hover:bg-slate-200 p-1'>
